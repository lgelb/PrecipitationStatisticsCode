...
skip missing data 2010

currently stuck on "IndexError: list index out of range" error for 2013
...
for n in range(startyear,endyear): #years 1999-2013, because exclusive    
    ...
    filename = "SCR_HrlySummary_{}.csv".format(n)    
