...
def calcPET_(filename,stationstats):
    ...
    cleanData_(precipHourly,temperatureC,solarradiation,netradiation,relativehumidity, \
        winddirectiondegree,windspeed,snowdepthcm)

#    checkMissingData_(precipHourly,temperatureC,solarradiation,netradiation,relativehumidity, \
#        winddirectiondegree,windspeed,snowdepthcm)
